...
<body>
    ...
    <div id="voteModal" class="vote-modal">
        <div class="vote-modal-content">
            ...
            <div style="margin-top: 15px;">
                <button class="vote-submit-btn" onclick="submitVote()">Submit Vote</button>
                <button class="vote-cancel-btn" onclick="closeVoteModal()">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        locations.forEach(function(location) {
            ...
            // Add vote button
            popupContent += `<button class="vote-button" onclick="openVoteModal('${location.name.replace(/'/g, "\\\\'")}')">🗳️ Vote</button>`;
